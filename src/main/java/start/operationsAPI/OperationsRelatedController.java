...
import start.logic.AdvancedOperationsService;
import start.logic.OperationsService;
...
public class OperationsRelatedController {
	...
	@RequestMapping(path = "/blockchain/admin/operations/{userSpace}/{userEmail}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(path = "/blockchain/operations", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	...
	@RequestMapping(path = "/blockchain/operations/async", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
